...
public class HashSetDemo1 {
	...
	public static void main(String[] args) {
		...
		//HashSet hs=new HashSet(10, (float) 0.90);   // here it is type casting
		...
		//System.out.println(hs.get());//incorrect.... get method is not possible
		
		//change the value - Not possible
		//hs.set(index, "X"); //incorrect
		
		//contains() - searching
		System.out.println(hs.contains("welcome")); // true       // contains is case sensitive
		...
		//Reading elements from LL using for..each loop
			for(Object e:hs)
			{
				System.out.println(e);     // it will print the elements in random order
			}
		...
		Iterator it=hs.iterator();
				while(it.hasNext())
				{
					System.out.println(it.next());   // it will print the elements in random order
